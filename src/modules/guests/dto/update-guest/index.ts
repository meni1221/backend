...
import { GuestLanguage, GuestStatus } from '../../schemas';

export class UpdateGuestDto {
  @ApiPropertyOptional({ example: 'Dana Cohen', maxLength: 140 })
  @IsOptional()
  @IsString()
  @MaxLength(140)
  fullName?: string;
  ...
  @ApiPropertyOptional({ enum: GuestStatus, example: GuestStatus.PENDING })
  @IsOptional()
  @IsEnum(GuestStatus)
  status?: GuestStatus;
